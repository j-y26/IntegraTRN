...
- An lightweight example miRNA-gene interaction dataset with queried
  using a miRNA centric approach: `mir2geneMultiMiR`
...
- An example MOList object containing all types of omics data, but with
  a very light weight (100 genes only): `expMOList`
