...
myMOList <- loadExtInteractions(myMOList,
  upregmiR2Genes = upregmiR2gene,
  downregmiR2Genes = downregmiR2gene,
  upregTF2Genes = upregTF2gene,
  downregTF2Genes = downregTF2gene
)
```
...
omiCutoffs <- setOmicCutoffs(
  ...
  smallRNALogFC = 0.1,
  smallRNATopGenes = 0.1,
  atacMotifPval = 0.01
)
```

```{r message = FALSE, tidy=TRUE, warning=FALSE}
# Construct the small RNA - TF - target gene network
