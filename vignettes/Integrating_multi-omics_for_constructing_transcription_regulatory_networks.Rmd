...
data("RNAseq_heart", package = "IntegraTRN") # RNAseq count matrix
data("RNAseq_heart_samples", package = "IntegraTRN") # RNAseq sample information
data("smallRNAseq_heart", package = "IntegraTRN") # small RNAseq count matrix
data("smallRNAseq_heart_samples", package = "IntegraTRN") # small RNAseq sample information
```
