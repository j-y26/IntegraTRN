...
nocite: |
  @chang2020mirnet, @villanueva2019ggplot2, @dplyr, @DT
---
...
# Let us explore it interactively
DT::datatable(myTopRNAResults, options = list(pageLength = 5))
```
...
DT::datatable(myMotifs, options = list(pageLength = 5, scrollX = TRUE))
```
