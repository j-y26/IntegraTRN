...
```{r message = FALSE, tidy=TRUE, fig.align='center', fig.width=6, fig.height=5, fig.cap="Figure 6. ATACseq coverage"}
...
```{r message = FALSE, tidy=TRUE, warning=FALSE, fig.align='center', fig.width=6, fig.height=5, fig.cap="Figure 8. The Transcriptional Regulatory Network"}
# Plot the network
plotNetwork(myTRNet, interactive = TRUE)
```

```{r message = FALSE, tidy=TRUE, warning=FALSE}
# Make a smaller network with only upregulated genes and miRNA
...
```{r message = FALSE, tidy=TRUE, warning=FALSE, fig.align='center', fig.width=6, fig.height=5, fig.cap="Figure 9. The Transcriptional Regulatory Network of Up-regulated Genes"}
# Plot the network
