...
As an example, we use the **`multiMiR`** package to fetch the miRNA-target
interactions from multiple databases.
...
mir2geneMultiMiR <- mir2geneMultiMiR %>%
  ...
  dplyr::rename(regulator = mature_mirna_id,
...
Without protein, the network we obtained is fairly large.

```{r message = FALSE, warning=FALSE, fig.align='center', fig.width=5, fig.height=4, fig.cap="Figure 2. TRN constructed with without considering protein expression" }
...
```{r message = FALSE, warning=FALSE, fig.align='center', fig.width=8, fig.height=6, fig.cap="Figure 3. TRN constructed with coherent protein expression" }
...
```{r message = FALSE, warning=FALSE, fig.align='center', fig.width=8, fig.height=6, fig.cap="Figure 4. miRNA-target gene TRN constructed with coherent protein expression" }
